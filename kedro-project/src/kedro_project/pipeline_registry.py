...
def register_pipelines() -> Dict[str, Pipeline]:
    ...
    if os.environ.get("get_data") == "True":
        ...
        return {"get_data": get_data_pipeline, "preprocess": preprocess_pipeline, "train": preprocess_train, "__default__": get_data_pipeline + preprocess_pipeline}
    else:
        # データの前処理から行う場合
        return {"preprocess": preprocess_pipeline, "train": preprocess_train, "__default__": preprocess_pipeline}